/*******************************************************************************
DO FILE NAME:			sens1-ecz-dep-time-updated-variables.do
...
TASK:					Create a dataset containing all the information
						...
						(sensitivity analysis 1) alternative code list for depression
...
DATASETS CREATED:		sens1-ecz-dep-time-updated-variables
*******************************************************************************/
/*******************************************************************************
HOUSEKEEPING
*******************************************************************************/
...
global filename "sens1-ecz-dep-time-updated-variables"
...
append using "${pathIn}/outcome-ecz-dep-all"
...
collapse (firstnm) modsevere harmfulalcohol asthma sleep depression_all depression_censor steroids, by(patid date)
...
local update " "modsevere" "harmfulalcohol" "asthma" "sleep" "depression_all" "depression_censor" "steroids" "
...
drop sleep modsevere harmfulalcohol asthma depression_all depression_censor steroids

rename statemodsevere modsevere
rename statesleep sleep
rename stateharmfulalcohol harmfulalcohol
rename stateasthma asthma
rename statedepression_all depression_all
...
*save
save "${pathCohort}/sens1-ecz-dep-time-updated-variables", replace
