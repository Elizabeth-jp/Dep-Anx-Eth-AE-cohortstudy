/*******************************************************************************
DO FILE NAME:			sens4-ecz-dep-time-updated-variables.do
...
TASK:					Time-updated variables for sensitivity analysis 4 
						(not censoring at alternative diagnosis) depression
						cohort
...
DATASETS CREATED:		sens4-ecz-dep-time-updated-variables
*******************************************************************************/
/*******************************************************************************
HOUSEKEEPING
*******************************************************************************/
...
global filename "sens4-ecz-dep-time-updated-variables"
...
collapse (firstnm) modsevere harmfulalcohol asthma sleep depression steroids, by(patid date)
...
local update " "modsevere" "harmfulalcohol" "asthma" "sleep" "depression" "steroids" "
...
drop sleep modsevere harmfulalcohol asthma depression steroids
...
*save
save "${pathCohort}/sens4-ecz-dep-time-updated-variables", replace
