/*******************************************************************************
DO FILE NAME:			main-ecz-anx-regression.do
...
TASK:					Aim is to create an excel file containing the regression analysis
						association between eczema and anxiety modified by ethnicity?
						
DATASET(S)/FILES USED:	cohort-anx-ecz-main.dta
						

DATASETS CREATED:		main-ecz-anx-regression.xls
...
global filename "main-ecz-anx-regression"
...
* create excel file
putexcel set "${pathResults}/main-ecz-anx-regression.xlsx", sheet(main_minimally) modify

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Table x. Hazard ratios (95% CIs) for the association between atopic eczema and anxiety, stratified by ethnicity (minimally adjusted).", bold
local ++rowcount 
...
* create excel file
putexcel set "${pathResults}/main-ecz-anx-regression.xlsx", sheet(main_confounder) modify
...
* create excel file
putexcel set "${pathResults}/main-ecz-anx-regression.xlsx", sheet(main_mediator) modify
