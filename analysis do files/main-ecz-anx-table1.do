/*******************************************************************************
DO FILE NAME:			main-ecz-anx-table1.do
...
TASK:					Aim is to create an excel file containing figures for
						table 1 (n(%)) for the eczema anxiety cohort
						
DATASET(S)/FILES USED:	cohort-anx-ecz-main.dta
						

DATASETS CREATED:		main-ecz-anx-table1.xls
...
global filename "main-ecz-anx-table1"
...
* create excel file
putexcel set "${pathResults}/main-ecz-anx-table1.xlsx", replace

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Table x. Characteristics of the study population at cohort entry stratified by atopic eczema exposure status (anxiety cohort)." 
...
putexcel A`rowcount'="*Follow-up based on censoring at the earliest of: death, no longer registered with practice, practice no longer contributing to CPRD, anxiety diagnosis, or diagnosis suggesting an alternative cause for the anxiety outcome (e.g., severe mental illness) "
local ++rowcount
