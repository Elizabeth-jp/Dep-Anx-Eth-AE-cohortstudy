...
DATASETS CREATED:		sens2-cohort-dep-ecz
						sens2-ecz-dep.xls
*******************************************************************************/
/*******************************************************************************
HOUSEKEEPING
...
*save the dataset
save "${pathCohort}/sens2-cohort-dep-ecz-exposed", replace

/*******************************************************************************
#1.2: Deal with time-updated variables
*******************************************************************************/
*merge in time-updated variables dataset
merge 1:m patid using "${pathCohort}/sens2-ecz-dep-time-updated-variables"
...
merge m:1 patid using "${pathCohort}/sens2-cohort-dep-ecz-exposed"
...
*save the dataset
save "${pathCohort}/sens2-cohort-dep-ecz-unexposed", replace
...
merge m:1 patid using "${pathCohort}/sens2-cohort-dep-ecz-unexposed"
...
*******************************************************************************/
append using "${pathCohort}/sens2-cohort-dep-ecz-exposed"
...
*save the dataset
save "${pathCohort}/sens2-cohort-dep-ecz-main", replace

*delete interim datasets
erase "${pathCohort}/sens2-cohort-dep-ecz-exposed.dta"
erase "${pathCohort}/sens2-cohort-dep-ecz-unexposed.dta"
...
*save the dataset
save "${pathCohort}/sens2-cohort-dep-ecz", replace
...
/*
--------------------------------------------------------------------------
  1,096,911  total observations
         14  observations end on or before enter()
--------------------------------------------------------------------------
  1,096,897  observations remaining, representing
    847,928  subjects
...
*******************************************************************************/
*recode those with missing harmful alcohol, sleep_all, steroids and depression as not having them
recode harmfulalcohol (.=0)
recode asthma (.=0)
recode sleep_all (.=0)
recode depression (.=0)
...
use "${pathCohort}/sens2-cohort-dep-ecz", clear
...
* create excel file
putexcel set "${pathResults}/sens2-ecz-dep-regression.xlsx", sheet(confounder) modify
...
* create excel file
putexcel set "${pathResults}/sens2-ecz-dep-regression.xlsx", sheet(mediator) modify
