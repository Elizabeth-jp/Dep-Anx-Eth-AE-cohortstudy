/*******************************************************************************
DO FILE NAME:			impute-ecz-dep-table1.do
...
DATASET(S)/FILES USED:	sens5b-cohort-dep-ecz.dta
						

DATASETS CREATED:		sens5b-dep-table1.xls
...
global filename "impute-ecz-dep-table1"
...
* create excel file
putexcel set "${pathResults}/sens5b-ecz-dep-table1.xlsx", replace

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Table x. Characteristics of the study population (multiple imputation) at cohort entry stratified by atopic eczema exposure status (depression cohort)." 
