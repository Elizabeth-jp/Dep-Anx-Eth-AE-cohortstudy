...
DATASETS CREATED:		sens3-ecz-anx.xls
*******************************************************************************/
/*******************************************************************************
HOUSEKEEPING
*******************************************************************************/
...
* create excel file
putexcel set "${pathResults}/sens3-ecz-anx-regression.xlsx", sheet(confounder) modify
...
* create excel file
putexcel set "${pathResults}/sens3-ecz-anx-regression.xlsx", sheet(mediator) modify
