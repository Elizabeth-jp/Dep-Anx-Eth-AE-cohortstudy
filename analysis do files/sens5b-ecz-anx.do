/*******************************************************************************
DO FILE NAME:			sens5b-ecz-anx.do
...
DATASETS CREATED:		sens5b-cohort-anx-ecz
						sens5b-ecz-anx.xls
*******************************************************************************/
/*******************************************************************************
HOUSEKEEPING
...
global filename "sens5b-ecz-anx"
...
*save the dataset
save "${pathCohort}/sens5b-cohort-anx-ecz-exposed", replace
...
merge m:1 patid using "${pathCohort}/sens5b-cohort-anx-ecz-exposed"
...
*save the dataset
save "${pathCohort}/sens5b-cohort-anx-ecz-unexposed", replace
...
merge m:1 patid using "${pathCohort}/sens5b-cohort-anx-ecz-unexposed"
...
*******************************************************************************/
append using "${pathCohort}/sens5b-cohort-anx-ecz-exposed"
...
*save the dataset
save "${pathCohort}/sens5b-cohort-anx-ecz", replace

*delete interim datasets
erase "${pathCohort}/sens5b-cohort-anx-ecz-exposed.dta"
erase "${pathCohort}/sens5b-cohort-anx-ecz-unexposed.dta"
...
*******************************************************************************/
use "${pathCohort}/sens5b-cohort-anx-ecz", clear
...
mi impute logit ethnicity anxiety i.exposed i.carstairs_deprivation, add(10) rseed(743) force 

*mi stset
mi stset end, fail(anxiety==1) origin(realyob) enter(indexdate) id(patid) scale(365.25)
...
* create excel file
putexcel set "${pathResults}/sens5b-ecz-anx-regression.xlsx", sheet(confounder) modify
