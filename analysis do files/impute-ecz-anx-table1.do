/*******************************************************************************
DO FILE NAME:			impute-ecz-anx-table1.do
...
TASK:					Aim is to create an excel file containing figures for
						table 1 (n(%)) for the characateristics of the imputed
						anxiety cohort
						
DATASET(S)/FILES USED:	sens5b-cohort-anx-ecz.dta
						

DATASETS CREATED:		sens5b-anx-table1.xls
...
global filename "impute-ecz-anx-table1"
...
* create excel file
putexcel set "${pathResults}/sens5b-ecz-anx-table1.xlsx", replace

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Table x. Characteristics of the study population (multiple imputation) at cohort entry stratified by atopic eczema exposure status (anxiety cohort)." 
...
recode ethnicity 0=0 1=1 .=2
label define ethnic 0"White" 1"Minority ethnic" 2"Missing"
