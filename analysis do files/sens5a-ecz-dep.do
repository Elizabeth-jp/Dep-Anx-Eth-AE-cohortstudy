/*******************************************************************************
DO FILE NAME:			sens5a-ecz-dep.do
...
DATASETS CREATED:		sens5a-cohort-dep-ecz
						sens5a-ecz-dep.xls
*******************************************************************************/
/*******************************************************************************
HOUSEKEEPING
...
global filename "sens5a-ecz-dep"
...
*save the dataset
save "${pathCohort}/sens5a-cohort-dep-ecz-exposed", replace
...
merge m:1 patid using "${pathCohort}/sens5a-cohort-dep-ecz-exposed"
...
*save the dataset
save "${pathCohort}/sens5a-cohort-dep-ecz-unexposed", replace
...
merge m:1 patid using "${pathCohort}/sens5a-cohort-dep-ecz-unexposed"
...
*******************************************************************************/
append using "${pathCohort}/sens5a-cohort-dep-ecz-exposed"
...
*save the dataset
save "${pathCohort}/sens5a-cohort-dep-ecz-main", replace

*delete interim datasets
erase "${pathCohort}/sens5a-cohort-dep-ecz-exposed.dta"
erase "${pathCohort}/sens5a-cohort-dep-ecz-unexposed.dta"
...
unique patid 
*Total number of people is 449,813

unique patid if exposed==1
*Number of unique values of patid is  118,386

unique patid if exposed==0
*Number of unique values of patid is 339,243
...
*save the dataset
save "${pathCohort}/sens5a-cohort-dep-ecz", replace
...
/*
--------------------------------------------------------------------------
    570,507  total observations
          9  observations end on or before enter()
--------------------------------------------------------------------------
    570,498  observations remaining, representing
    449,813  subjects
     34,035  failures in single-failure-per-subject data
  1,648,962  total analysis time at risk and under observation
...
*******************************************************************************/
use "${pathCohort}/sens5a-cohort-dep-ecz", clear
...
* create excel file
putexcel set "${pathResults}/sens5a-ecz-dep-table1.xlsx", replace

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Table x. Characteristics of the study population (hes linked) at cohort entry stratified by atopic eczema exposure status (depression cohort)." 
...
* create excel file
putexcel set "${pathResults}/sens5a-ecz-dep-regression.xlsx", sheet(confounder) modify
...
* create excel file
putexcel set "${pathResults}/sens5a-ecz-dep-regression.xlsx", sheet(mediator) modify
