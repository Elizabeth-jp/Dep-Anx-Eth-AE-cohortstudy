/*******************************************************************************
DO FILE NAME:			appendix-ecz-dep-prophazards.do
...
global filename "appendix-ecz-dep-prophazards"
...
estat phtest, detail
* p value is 0.6832 - there is no evidence that the proportional hazards assumption has been violated
...
graph save "${pathResults}/appendix-ecz-dep-prophazards-white.gph",replace

*minority ethnic group
stcox i.exposed i.calendarperiod i.carstairs_deprivation if ethnicity==2, strata(setid) level(95) base
estat phtest, detail
* p value is 0.2689 - there is no evidence that the proportional hazards assumption has been violated

*draw graph in minority ethnic group 
*exposed
estat phtest, plot(1.exposed) bwidth(0.5) recast(scatter) mcolor(black) msize(small) msymbol(point) lineopts(lwidth(thin))
graph save "${pathResults}/appendix-ecz-dep-prophazards-minorityethnic.gph",replace
