/*******************************************************************************
DO FILE NAME:			appendix-ecz-anx-missingChar.do
...
DATASETS CREATED:		appendix-ecz-anx-missingChar.xls
...
global filename "appendix-ecz-anx-missingChar"
...
foreach sample in all model1 noCar model4 noBMI noSmok {
	...
	*currently 0=non smoker, 1=current 2=ex 12=current or ex
	...
	label define sleeplabel2 1"Yes" 2"No"
	label values sleep sleeplabel2
...
*******************************************************************************/
* create excel file
putexcel set "${pathResults}/appendix-ecz-anx-missingChar.xlsx", replace
